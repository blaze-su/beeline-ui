...
const App = () => {
   ...
   const getAvailabilityInCities = useCallback(
      (value: string) => {
         const cities: City[] = [];
      ...
      <div className={style.app}>
         <div className={style.box}>
            ...
            <div className={style.field}>
               <input className={style.input} onChange={handleChange} value={number} />
            </div>
            ...
            <GroupNumber
               data={Array.from(numbers.values())}
               getAvailabilityInCities={getAvailabilityInCities}
            />
         </div>
      </div>
   );
